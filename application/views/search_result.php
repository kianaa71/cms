...
<head>
	...
	<!-- <style>
		.blog-wrapper {
			...
			align-items: center;
			/* Mengatur konten blog secara horizontal dan vertikal di tengah */
			height: 100vh;
			/* Opsi: Mengisi setinggi viewport */
		}
...
<body>
	...
	<!-- Navbar End -->
	<!-- <div class="blog-wrapper" style="display: flex; justify-content: center;"> -->
	<!-- Blog Start -->
			...
			<div class="row g-5">
							...
							<div class="blog-item bg-light rounded overflow-hidden">
								<div class="blog-img position-relative overflow-hidden">
									...
									<a
										...
										<?= $michie['nama_kategori'] ?></a>
								</div>
								<div class="p-4">
									<div class="d-flex mb-3">
										<small class="me-3">
											<i class="far fa-user text-primary me-2"></i><?= $michie['username'] ?>
										</small>
										<small>
											<i
												class="far fa-calendar-alt text-primary me-2"></i><?= $michie['tanggal'] ?>
										</small>
									</div>
									<h4 class="mb-3"><?= $michie['judul'] ?></h4>
									<a class="text-uppercase"
										href="<?= base_url('homie/artikel/'.$michie['slug']) ?>">Read More
				...
				<div class="col-lg-4">
					<div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
						<div class="mb-5 wow" data-wow-delay="0.1s">
							<form method="post" action="<?= base_url('homie/search') ?>" class="input-group">
								<input type="text" id="search-input" name="keyword" class="form-control p-3"
									placeholder="Keyword">
								<button id="search-btn" type="submit" class="btn btn-primary px-4">
					...
					<div class="link-animated d-flex flex-column justify-content-start">
						<a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="<?= base_url() ?>">
							<i class="bi bi-arrow-right me-2"></i>Home
						</a>
						<?php foreach ($kategori as $ichiro) { ?>
						<div class="link-animated d-flex flex-column justify-content-start">
							<a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"
								href="<?= base_url('homie/kategori/'.$ichiro['id_kategori']) ?>">
								<i class="bi bi-arrow-right me-2"></i><?= $ichiro['nama_kategori'] ?>
							</a>
						</div>
						<?php } ?>
					</div>
